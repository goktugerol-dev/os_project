...
# DEFINE COMMANDS THAT NEEDS TO BE BUILT THE OBJECT FILES
# CHECKING THE EXISTENCE OF THE DIRECTORY TO HOLD THE COMPILED FILE

	mkdir -p $(dir $@) && \

# USING NASM TO COMPILE THE ASSEMBLY CODE. 
# USING F FLAG TO CHANGE THE FORMAT OF THE OBJECT FILE

  nasm -f elf64 $(patsubst build/x86_64/%.o, src/impl/x86_64/%.asm, $@) -o $@ 	# INPUT OF THE NASM COMMAND
